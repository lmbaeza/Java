...
* [Setup](#setup)
* [charAt(int index) char](#charatint-index-char)
* [codePointAt(int index) int](#codepointatint-index-int)
* [codePoints() IntStream](#codepoints-intstream)
* [chars() IntStream](#chars-intstream)
* [compareTo(String anotherString) int](#comparetostring-anotherstring-int)
* [compareToIgnoreCase(String anotherString) int](#comparetoignorecasestring-anotherstring-int)
* [concat(String str) String](#concatstring-str-string)
* [contains(String str) boolean](#containsstring-str-boolean)
* [endsWith(String str) boolean](#endswithstring-str-boolean)
* [equals(String str) boolean](#equalsstring-str-boolean)
* [equalsIgnoreCase(String str) String](#equalsignorecasestring-str-string)
* [getBytes() byte []](#getbytes-byte-)
* [hashCode() int](#hashcode-int)
* [indexOf(String str) int](#indexofstring-str-int)
* [indexOf(char character) int](#indexofchar-character-int)
* [isBlank() boolean](#isblank-boolean)
* [isEmpty() boolean](#isempty-boolean)
* [lastIndexOf(String str) int](#lastindexofstring-str-int)
* [lastIndexOf(char character) int](#lastindexofchar-character-int)
* [lines() Stream<String>](#lines-stream)
* [matches(String regex) boolean](#matchesstring-regex-boolean)
* [replace(String oldStr, String newStr) String](#replacestring-oldstr-string-newstr-string)
* [replace(char oldChar, char newChar) String](#replacechar-oldchar-char-newchar-string)
* [replaceAll(String str) String](#replaceallstring-str-string)
* [split(String str) String[]](#splitstring-str-string)
* [substring(int from, int to) String](#substringint-from-int-to-string)
* [substring(int from) String](#substringint-from-string)
* [toCharArray() char[]](#tochararray-char)
